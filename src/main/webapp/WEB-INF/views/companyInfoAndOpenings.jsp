    ...
    <div class="page-wrapper bg-blue p-t-180 p-b-100 font-robo" style="padding-top:100px;">
        <div class="wrapper wrapper--w960">
            <div class="card card-2">
                <div class="card-background" style="padding:10px;">
                    <h2>Filters</h2>
                    <form:form method="POST" modelAttribute="filters">
                    <form:input type="hidden" path="company" id="company" value="${company.name}" />
                    ...
                    <div class="input-group">
                        <form:input class="input--style-2" type="text" placeholder="Min Salary" name="salary" path="salary" id="location"/>
                    </div>
                    <div class="p-t-30">
                        <input class="btn btn--radius btn--green" type="submit" value="Apply Filter"/>
                    </div>
                    </form:form>
                </div>
                    <div class="card-body" style="background-color:#f5f5f0;">
                        <h2>${company.name}</h2>
                            <ul>
                                <li>${company.intro}</li>
                                <li>${company.company_type} | ${company.location} |
                                ${company.domain} | ${company.employees_min} - ${company.employees_max}</li>
                                <li>Link : ${company.company_link}</li>
                                <li>Description : ${company.company_desc}</li>
                                <li>Founders : ${company.founder_name}
                                    <br>
                                    <p>
                                        ${company.founder_desc}
                                    </p>
                                </li>
                            </ul>
                        <h3>Openings</h3>
